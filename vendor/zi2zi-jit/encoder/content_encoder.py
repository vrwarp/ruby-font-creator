...
class ContentEncoder(nn.Module):
    """
    Content encoder for extracting global content embeddings from 256x256 images.

    Architecture (6 blocks):
        - 6 DBlocks with spectral normalization, each halving spatial resolution
        - Channel progression: 3 -> 64 -> 128 -> 256 -> 512 -> 1024 -> 1024
    ...
    Example:
        >>> encoder = ContentEncoder(hidden_size=512)
    ...
    def __init__(
        ...
        # Channel config for 6 blocks
        # Spatial: 256 -> 128 -> 64 -> 32 -> 16 -> 8 -> 4
        # Channels: 3 -> 64 -> 128 -> 256 -> 512 -> 1024 -> 1024
        in_channels = [input_nc, ch, ch * 2, ch * 4, ch * 8, ch * 16]
        out_channels = [ch, ch * 2, ch * 4, ch * 8, ch * 16, ch * 16]
    ...
    def forward(self, x: torch.Tensor) -> torch.Tensor:
        ...
        Returns:
            Content embedding of shape (B, hidden_size)
        """
        h = x
