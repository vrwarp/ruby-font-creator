...
var loadPyodide = (() => {
  ...
  var f = (t, e) => w(t, 'name', { value: e, configurable: !0 }),
    g = ((t) =>
      typeof require < 'u'
        ? require
        : typeof Proxy < 'u'
  ...
  var U = (t, e) => () => (e || t((e = { exports: {} }).exports, e), e.exports),
    fe = (t, e) => {
      for (var o in e) w(t, o, { get: e[o], enumerable: !0 })
    },
    M = (t, e, o, a) => {
      if ((e && typeof e == 'object') || typeof e == 'function')
        for (let l of ce(e))
          !de.call(t, l) &&
            ...
            w(t, l, {
              get: () => e[l],
              enumerable: !(a = se(e, l)) || a.enumerable,
            })
      return t
    }
  var h = (t, e, o) => (
      ...
      M(
        e || !t || !t.__esModule
          ? w(o, 'default', { value: t, enumerable: !0 })
          : o,
        t,
      )
    ),
    ue = (t) => M(w({}, '__esModule', { value: !0 }), t)
  var C = U((P, $) => {
    ;(function (t, e) {
      'use strict'
      ...
      ;(f(c, 'StackFrame'),
        (c.prototype = {
          ...
          setEvalOrigin: function (d) {
            if (d instanceof c) this.evalOrigin = d
            else if (d instanceof Object) this.evalOrigin = new c(d)
            else
        ...
        (c.fromString = f(function (y) {
          ...
          return new c({
            ...
            args: ne || void 0,
            fileName: re,
            lineNumber: ie || void 0,
            columnNumber: oe || void 0,
          })
        }, 'StackFrame$$fromString')))
      for (var s = 0; s < a.length; s++)
        ((c.prototype['get' + e(a[s])] = o(a[s])),
          (c.prototype['set' + e(a[s])] = (function (d) {
            return function (y) {
              this[d] = !!y
            }
          })(a[s])))
      for (var m = 0; m < l.length; m++)
        ((c.prototype['get' + e(l[m])] = o(l[m])),
          (c.prototype['set' + e(l[m])] = (function (d) {
            return function (y) {
      ...
      for (var p = 0; p < n.length; p++)
        ((c.prototype['get' + e(n[p])] = o(n[p])),
          (c.prototype['set' + e(n[p])] = (function (d) {
            return function (y) {
              this[d] = String(y)
            }
          })(n[p])))
  ...
  var j = U((x, W) => {
    ;(function (t, e) {
      ...
      f(function (e) {
        ...
        return {
          parse: f(function (r) {
            if (typeof r.stacktrace < 'u' || typeof r['opera#sourceloc'] < 'u')
...
`),
              ...
              p &&
                c.push(
                  new e({ fileName: p[2], lineNumber: p[1], source: i[s] }),
                )
            }
            return c
...
`,
  ...
  var v =
    ...
    q = H && typeof importScripts == 'function' && typeof self == 'object',
    ke =
  ...
  async function A() {
    if (
      !v ||
      ((J = (await import(/* webpackIgnore */ 'node:url')).default),
      (V = await import(/* webpackIgnore */ 'node:fs')),
      (I = await import(/* webpackIgnore */ 'node:fs/promises')),
      (X = (await import(/* webpackIgnore */ 'node:vm')).default),
      (k = await import(/* webpackIgnore */ 'node:path')),
      (L = k.sep),
      typeof g < 'u')
    )
      return
    let t = V,
      e = await import(/* webpackIgnore */ 'node:crypto'),
      o = await import(/* webpackIgnore */ 'ws'),
      a = await import(/* webpackIgnore */ 'node:child_process'),
      l = { fs: t, crypto: e, ws: o, child_process: a }
  ...
  f(G, 'loadBinaryFile')
  var S
  if (z) S = f(async (t) => await import(/* webpackIgnore */ t), 'loadScript')
  else if (q)
    S = f(async (t) => {
      try {
  ...
  async function ve(t) {
    ;(t.startsWith('file://') && (t = t.slice(7)),
      t.includes('://')
        ? X.runInThisContext(await (await fetch(t)).text())
        : await import(/* webpackIgnore */ J.pathToFileURL(t).href))
  }
  f(ve, 'nodeLoadScript')
  async function Y(t) {
    if (v) {
      await A()
      let e = await I.readFile(t, { encoding: 'utf8' })
      return JSON.parse(e)
  ...
  async function Q() {
    ...
    let e = K.default.parse(t)[0].fileName
    if (B) {
      let a = await import(/* webpackIgnore */ 'node:path')
      return (await import(/* webpackIgnore */ 'node:url')).fileURLToPath(
        a.dirname(e),
      )
    }
    let o = e.lastIndexOf(L)
    if (o === -1)
      throw new Error(
      ...
      l = {
        ...
        getLocalSet: (n) => {
          ...
          for (; c.length; ) {
            let s = c.pop(),
              m = e.stat(s)
            ;(e.isDir(m.mode) &&
              c.push.apply(c, e.readdir(s).filter(u).map(i(s))),
              (r[s] = { timestamp: m.mtime, mode: m.mode }))
          }
          return { type: 'local', entries: r }
        },
        getRemoteSet: async (n) => {
          let r = Object.create(null),
            u = await Ee(n.opts.fileSystemHandle)
          for (let [i, c] of u)
            i !== '.' &&
              (r[a.join2(n.mountpoint, i)] = {
                timestamp:
                  c.kind === 'file'
                    ? (await c.getFile()).lastModifiedDate
                    : new Date(),
                mode: c.kind === 'file' ? l.FILE_MODE : l.DIR_MODE,
              })
          return { type: 'remote', entries: r, handles: u }
        },
        loadLocalEntry: (n) => {
          ...
          if (e.isFile(i.mode))
            return (
              (u.contents = o.getFileDataAsTypedArray(u)),
              { timestamp: i.mtime, mode: i.mode, contents: u.contents }
            )
          throw new Error('node type not supported')
        },
        storeLocalEntry: (n, r) => {
          if (e.isDir(r.mode)) e.mkdirTree(n, r.mode)
          else if (e.isFile(r.mode)) e.writeFile(n, r.contents, { canOwn: !0 })
        ...
        loadRemoteEntry: async (n) => {
          if (n.kind === 'file') {
            ...
            if (n.kind === 'directory')
              return { mode: l.DIR_MODE, timestamp: new Date() }
        ...
        storeRemoteEntry: async (n, r, u) => {
          let i = n.get(a.dirname(r)),
            c = e.isFile(u.mode)
              ? await i.getFileHandle(a.basename(r), { create: !0 })
              : await i.getDirectoryHandle(a.basename(r), { create: !0 })
          if (c.kind === 'file') {
        ...
        reconcile: async (n, r, u) => {
          ...
          for (let p of c) {
            ...
            if (u.type === 'local') {
              let y = m.get(d),
                E = await l.loadRemoteEntry(y)
              l.storeLocalEntry(p, E)
            } else {
          ...
          for (let p of s)
            if (u.type === 'local') l.removeLocalEntry(p)
            else {
              let d = a.normalize(p.replace(n.mountpoint, '/')).substring(1)
  ...
  var Ee = f(async (t) => {
    let e = []
    async function o(l) {
      for await (let n of l.values())
        (e.push(n), n.kind === 'directory' && (await o(n)))
    }
  ...
  function ee(t) {
    let e = {
      ...
      preRun: Re(t),
      quit(o, a) {
        throw ((e.exited = { status: o, toThrow: a }), a)
      },
      print: t.stdout,
      printErr: t.stderr,
      arguments: t.args,
  ...
  function _e(t) {
    ...
    return (o) => {
      ...
      ;(o.FS.mkdirTree('/lib'),
        o.FS.mkdirTree(`/lib/python${a}.${l}/site-packages`),
  ...
  function Re(t) {
    ...
    return (
      t.stdLibURL != null
        ? (e = t.stdLibURL)
        : (e = t.indexURL + 'python_stdlib.zip'),
      [_e(e), be(t.env.HOME), we(t.env), Se(t._node_mounts), Z]
    )
  }
  f(Re, 'getFileSystemInitializationFuncs')
  function Oe(t) {
    let { binary: e, response: o } = _(t + 'pyodide.asm.wasm')
    return function (a, l) {
      return (
        (async function () {
          try {
            ...
            o
              ...
              : (n = await WebAssembly.instantiate(await e, a))
            let { instance: r, module: u } = n
            ;(typeof WasmOffsetConverter < 'u' &&
              (wasmOffsetConverter = new WasmOffsetConverter(wasmBinary, u)),
              l(r, u))
          } catch (n) {
  ...
  f(Oe, 'getInstantiateWasmFunc')
  var R = '0.26.1'
  async function D(t = {}) {
    await A()
    let e = t.indexURL || (await Q())
    ;((e = O(e)), e.endsWith('/') || (e += '/'), (t.indexURL = e))
    let o = {
        fullStdLib: !1,
    ...
    let l = ee(a),
      n = l.API
    if (
      ((n.lockFilePromise = Y(a.lockFileURL)),
    ...
    if (t._loadSnapshot) {
      ...
      ;(ArrayBuffer.isView(s) ? (r = s) : (r = new Uint8Array(s)),
        (l.noInitialRun = !0),
        (l.INITIAL_MEMORY = r.length))
    }
    let u = await _createPyodideModule(l)
    if (l.exited) throw l.exited.toThrow
    if (
      (t.pyproxyToStringRepr && n.setPyProxyToStringMethod(!0), n.version !== R)
    )
      throw new Error(
        `Pyodide version does not match: '${R}' <==> '${n.version}'. If you updated the Pyodide version, make sure you also updated the 'indexURL' parameter passed to loadPyodide.`,
      )
    u.locateFile = (s) => {
    ...
    return (
      ...
      c.version.includes('dev') ||
        n.setCdnUrl(`https://cdn.jsdelivr.net/pyodide/v${c.version}/full/`),
      n._pyodide.set_excepthook(),
      await n.packageIndexReady,
      n.initializeStreams(a.stdin, a.stdout, a.stderr),
      c
    )
  }
  f(D, 'loadPyodide')
  globalThis.loadPyodide = D
  return ue(Ne)
})()
try {
