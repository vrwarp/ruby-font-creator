"""
KS X 1001 charset Unicode codepoints (Hangul only).

KS X 1001 contains 2,350 Hangul syllables (most common subset of the full 11,172).
This file excludes Hanja (Chinese characters) and only includes Hangul.
"""

# KS X 1001 Hangul syllables only (2,350 characters)
_KSX1001_CODEPOINTS = [
...
KSX1001_CODEPOINTS = frozenset(_KSX1001_CODEPOINTS)
