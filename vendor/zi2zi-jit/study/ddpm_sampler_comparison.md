...
This note summarizes the practical difference between `heun` and `ab2` for the current zi2zi-JiT inference path, using the MPS benchmark run from the study worktree.
